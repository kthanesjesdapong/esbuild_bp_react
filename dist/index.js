...
(() => {
  ...
  // src/utils/cssHotReload.ts
  var cssHotReload = new EventSource("/esbuild").addEventListener("change", (e) => {
    var _a;
    ...
    if (!added.length && !removed.length && updated.length === 1) {
      for (const link of document.getElementsByTagName("link")) {
        ...
        if (url.host === location.host && url.pathname === updated[0]) {
          ...
          (_a = link.parentNode) == null ? void 0 : _a.insertBefore(next, link.nextSibling);
          return;
        }
      }
    }
  ...
  var App = ({ title }) => {
    cssHotReload;
    const h2Tag = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "man" });
  ...
  root.render(
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react.default.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(App_default, { title: "What-up" }) })
  );
})();
